...
export default {
    ...
    i18n: {
        ...
        en: {
            ...
            estimate: 'Knowledge of Derivative Product(s)',
            yearslong: 'Stocks Investment Experience',
            something: 'Warrants, CBBCs, ETF, Options, etc.',
            mulSelect: 'This is optional and you can choose more than one',
            continue: 'Continue',
            ...
            studyPro:
                'I underwent training or attended courses on derivative products that provide general knowledge of the nature and risks of derivatives',
