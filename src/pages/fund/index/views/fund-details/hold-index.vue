...
export default {
    i18n: {
        zhCHS: {
            ...
            msg1:
                '*本页面资料来源于基金管理公司、基金服务提供供应商。所有数据截至最新净值日期（除特殊标注外）,uSMART盈立证券对基金的业绩表现计算是按该时期的资产净值、相关类别货币计算。如有未显示年度/时期的表现，则指该年度/时期未有足够资料计算。',
            msg2:
        ...
        zhCHT: {
            ...
            msg1:
                '*本頁面資料來源於基金管理公司、基金服務提供供應商。所有數據截至最新淨值日期（除特殊標註外）,uSMART盈立證券對基金的業績表現計算是按該時期的資產淨值、相關類別貨幣計算。如有未顯示年度/時期的表現，則指該年度/時期未有足夠資料計算。',
            msg2:
    ...
    computed: {
        ...
        RedemptionButton() {
             ...
             * invate 是否是邀请
             */
            return this.btnShow && this.invate !== 'share'
        },
        /*
         * fightShow 是否拼团
         * invate 是否是邀请
