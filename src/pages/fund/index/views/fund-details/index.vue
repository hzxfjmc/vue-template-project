        ...
        .fund-footer-content(v-if="RedemptionButton")
            ...
            .fund-block--content
                .btn.colorbg.button-5width.btn-inverster(
                        ...
                        em(v-if="subscribeFeeVO.fundFeeLevelVOList[0].feeRate != 0 &&(fundFixedFeeVO.feeDiscount*100) != 0") {{$t([`享申购费${100-(fundFixedFeeVO.feeDiscount*100)}%`,`享認購費${100-(fundFixedFeeVO.feeDiscount*100)}%`,`Enjoy subscription fee ${100-(fundFixedFeeVO.feeDiscount*100)}%`])}}
