...
export default {
    ...
    methods: {
        tofundTrade() {
            let url = `${window.location.origin}/wealth/yxbao/index.html#/trade-rule?id=${this.fundTradeInfoVO.fundId}&assetType=${this.fundTradeInfoVO.assetType}&displayLocation=${this.$route.query.displayLocation}`
            jumpUrl(3, url)
        }
    }
}
